...
id:
  - excessive_utilities:speed_upgrade
  - excessive_utilities:speed_upgrade_magical
  - excessive_utilities:speed_upgrade_ultimate
icon: excessive_utilities:item/speed_upgrade
type: item
---
...
Additionally, you can modify the formula itself with [KubeJS]($devs/kubejs).

## Recipes

<ProjectRecipe id="excessive_utilities:speed_upgrade" />
<ProjectRecipe id="excessive_utilities:speed_upgrade_magical" />
<ProjectRecipe id="excessive_utilities:speed_upgrade_ultimate" />