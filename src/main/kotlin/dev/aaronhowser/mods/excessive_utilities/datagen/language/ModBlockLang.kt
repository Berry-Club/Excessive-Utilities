...
object ModBlockLang {
	...
	fun add(provider: ModLanguageProvider) {
		provider.apply {
			...
			addBlock(ModBlocks.SURVIVALIST_GENERATOR_MK2, "Survivalist Generator Mk2")
			addBlock(ModBlocks.FURNACE_GENERATOR_MK2, "Furnace Generator Mk2")
			addBlock(ModBlocks.MAGMATIC_GENERATOR_MK2, "Magmatic Generator Mk2")
			addBlock(ModBlocks.ENDER_GENERATOR_MK2, "Ender Generator Mk2")
			addBlock(ModBlocks.HEATED_REDSTONE_GENERATOR_MK2, "Heated Redstone Generator Mk2")
			addBlock(ModBlocks.CULINARY_GENERATOR_MK2, "Culinary Generator Mk2")
			addBlock(ModBlocks.POTIONS_GENERATOR_MK2, "Potions Generator Mk2")
			addBlock(ModBlocks.SOLAR_GENERATOR_MK2, "Solar Generator Mk2")
			addBlock(ModBlocks.EXPLOSIVE_GENERATOR_MK2, "Explosive Generator Mk2")
			addBlock(ModBlocks.PINK_GENERATOR_MK2, "Pink Generator Mk2")
			addBlock(ModBlocks.HIGH_TEMPERATURE_FURNACE_GENERATOR_MK2, "High-Temperature Furnace Generator Mk2")
			addBlock(ModBlocks.NETHER_STAR_GENERATOR_MK2, "Nether Star Generator Mk2")
			addBlock(ModBlocks.DISENCHANTMENT_GENERATOR_MK2, "Disenchantment Generator Mk2")
			addBlock(ModBlocks.FROSTY_GENERATOR_MK2, "Frosty Generator Mk2")
			addBlock(ModBlocks.HALITOSIS_GENERATOR_MK2, "Halitosis Generator Mk2")
			addBlock(ModBlocks.SLIMY_GENERATOR_MK2, "Slimy Generator Mk2")
			addBlock(ModBlocks.DEATH_GENERATOR_MK2, "Death Generator Mk2")
			addBlock(ModBlocks.RAINBOW_GENERATOR_MK2, "Rainbow Generator! Mk2")

			addBlock(ModBlocks.SURVIVALIST_GENERATOR_MK3, "Survivalist Generator Mk3")
			addBlock(ModBlocks.FURNACE_GENERATOR_MK3, "Furnace Generator Mk3")
			addBlock(ModBlocks.MAGMATIC_GENERATOR_MK3, "Magmatic Generator Mk3")
			addBlock(ModBlocks.ENDER_GENERATOR_MK3, "Ender Generator Mk3")
			addBlock(ModBlocks.HEATED_REDSTONE_GENERATOR_MK3, "Heated Redstone Generator Mk3")
			addBlock(ModBlocks.CULINARY_GENERATOR_MK3, "Culinary Generator Mk3")
			addBlock(ModBlocks.POTIONS_GENERATOR_MK3, "Potions Generator Mk3")
			addBlock(ModBlocks.SOLAR_GENERATOR_MK3, "Solar Generator Mk3")
			addBlock(ModBlocks.EXPLOSIVE_GENERATOR_MK3, "Explosive Generator Mk3")
			addBlock(ModBlocks.PINK_GENERATOR_MK3, "Pink Generator Mk3")
			addBlock(ModBlocks.HIGH_TEMPERATURE_FURNACE_GENERATOR_MK3, "High-Temperature Furnace Generator Mk3")
			addBlock(ModBlocks.NETHER_STAR_GENERATOR_MK3, "Nether Star Generator Mk3")
			addBlock(ModBlocks.DISENCHANTMENT_GENERATOR_MK3, "Disenchantment Generator Mk3")
			addBlock(ModBlocks.FROSTY_GENERATOR_MK3, "Frosty Generator Mk3")
			addBlock(ModBlocks.HALITOSIS_GENERATOR_MK3, "Halitosis Generator Mk3")
			addBlock(ModBlocks.SLIMY_GENERATOR_MK3, "Slimy Generator Mk3")
			addBlock(ModBlocks.DEATH_GENERATOR_MK3, "Death Generator Mk3")
			addBlock(ModBlocks.RAINBOW_GENERATOR_MK3, "Rainbow Generator! Mk3")
