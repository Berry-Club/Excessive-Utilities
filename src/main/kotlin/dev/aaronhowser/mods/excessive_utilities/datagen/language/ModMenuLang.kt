...
object ModMenuLang {
	...
	fun add(provider: ModLanguageProvider) {
		provider.apply {
			...
			add(MECHANICAL_USER_MODE_USE_ITEM_ON_BLOCK, "Use Item on Block")
			...
			add(MECHANICAL_USER_CLICK_RIGHT, "Right Click")
			add(MECHANICAL_USER_CLICK_LEFT, "Left Click")
			add(MECHANICAL_USER_SLOT_RANDOM, "Random Slot")
			add(MECHANICAL_USER_SLOT_UPPER_LEFT, "Top Left Slot")
