...
object ModMenuLang {
	...
	fun add(provider: ModLanguageProvider) {
		provider.apply {
			...
			add(MECHANICAL_USER_MODE_GENERIC_CLICK, "Generic Click")
			add(MECHANICAL_USER_MODE_PLACE_BLOCK, "Place Block")
			add(MECHANICAL_USER_MODE_USE_ITEM_ON_BLOCK, "Click Item on Block")
			add(MECHANICAL_USER_MODE_ACTIVATE_BLOCK_WITH_ITEM, "Activate Block with Item")
			add(MECHANICAL_USER_MODE_USE_ITEM, "Use Item")
			add(MECHANICAL_USER_MODE_ENTITY, "Click Entity")
			add(MECHANICAL_USER_CLICK_RIGHT, "Left Click")
			add(MECHANICAL_USER_CLICK_LEFT, "Right Click")
			add(MECHANICAL_USER_SLOT_RANDOM, "Random Slot")
			add(MECHANICAL_USER_SLOT_UPPER_LEFT, "Upper Left Slot")
			add(MECHANICAL_USER_SNEAKING_ON, "Sneak")
			add(MECHANICAL_USER_SNEAKING_OFF, "Sneakn't")
		}
	}
