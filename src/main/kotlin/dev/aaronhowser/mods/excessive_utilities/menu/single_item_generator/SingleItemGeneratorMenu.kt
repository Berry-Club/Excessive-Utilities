...
class SingleItemGeneratorMenu(
	...
	override fun addContainerSlots() {
		val inputSlot = ContainerSlot(generatorContainer, GeneratorContainer.INPUT_SLOT, 68, 46)
		val upgradeSlot = ContainerSlot(generatorContainer, GeneratorContainer.UPGRADE_SLOT, 153, 5)
